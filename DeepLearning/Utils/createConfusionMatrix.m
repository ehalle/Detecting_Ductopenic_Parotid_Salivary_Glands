...
ylabel({'Experts'' opinion', '(Ground Truth)'});
...
set(gca, 'XTick', 1:3, 'XTickLabel', {'Normal', 'Moderate', 'Severe'});
set(gca, 'YTick', 1:3, 'YTickLabel', {'Normal', 'Moderate', 'Severe'});


% Adjust axis label font size (example)
set(gca, 'FontSize', 10);  % Adjust axis label font size separately
