function [Iout,whatScale,Voutx,Vouty,Voutz]=FrangiFilter3D(I,options, use_gpu)
%
...
global use_gpu_g;
if ~exist('use_gpu','var'), use_gpu = use_gpu_g; end
...
for i = 1:length(sigmas)
    ...
    if isa(I, 'gpuArray')
        [Lambda1,Lambda2,Lambda3]=my_eig3volume(Dxx,Dxy,Dxz,Dyy,Dyz,Dzz);
    else
        if(nargout>2)
